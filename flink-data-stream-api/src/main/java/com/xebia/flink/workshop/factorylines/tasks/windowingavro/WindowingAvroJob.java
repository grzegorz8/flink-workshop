...
class WindowingAvroJob {
    ...
    private static final String BOOTSTRAP_SERVERS = "rta-kafka-kafka-bootstrap.kafka.svc.cluster.local:9092";
    private static final String SCHEMA_REGISTRY_URL = "http://schema-registry.kafka.svc.cluster.local:8081";
