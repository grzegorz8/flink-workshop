...
class StationInactivityDetectionV1Test {
    ...
    public void setupTestHarness() throws Exception {
        StationInactivityDetectionV1 function = new StationInactivityDetectionV1(Duration.ofMinutes(10L).toMillis());
    ...
    @Test
    @Disabled("Test fails. The logic does not handle this scenario.")
