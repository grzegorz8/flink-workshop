...
5. Run [ProcessingEventStateMigration.java](src/main/java/com/xebia/flink/workshop/stateprocessorapi/ProcessingEventStateMigration.java).
6. Upload generated savepoint.
7. Run [ProcessingEventJobV2.java](src/main/java/com/xebia/flink/workshop/stateprocessorapi/ProcessingEventJobV2.java).